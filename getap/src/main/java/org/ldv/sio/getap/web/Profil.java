...
public class Profil {
  ...
  public String doeditUserById(FormEditProfil formUser,
    ...
    if (bindResult.hasErrors()) {
      ...
      if (formUser.getMail().equals(null) || formUser.getMail().equals("")) {
        user.setMail(null);
      } else {
  ...
  /*
   * select * from user where login='admin' \G************************** 1. row
   * *************************** id: 1 nom: ADMIN prenom: Admin idEtab: NULL
   * login: admin mdp: admin hash: 21232f297a57a5a743894a0e4a801fc3 role: admin
   * idClasse: NULL mail: NULL idDiscipline: NULL
   */
